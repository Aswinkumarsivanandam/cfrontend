...
export class EditProfileComponent implements OnInit {
  ...
  onEmail() {
    let x = this.UserDetailsData.filter((x: { emailId: any; }) => x.emailId == this.EditProfileForm.value.Email)
  ...
  onUpdateProfile() {
    ...
    if (this.EditProfileForm.value.FirstName == null || this.EditProfileForm.value.FirstName == ''
      ...
      || this.EditProfileForm.value.Email == null || this.EditProfileForm.value.Email == ''
