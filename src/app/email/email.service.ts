...
export class EmailService {
  ...
  GetEmailByUserId(UserId : any){
    return this.http.get(this.APIURL + '/Email/getemailbyuserid/' + UserId,{responseType : 'json'});
  }

  GetEmailProvider(){
    return this.http.get(this.APIURL + '/Email/getemailprovider',{responseType : 'json'});
  }

  UpdateCredorEmailProvider(data : any){
    return this.http.post(this.APIURL + '/Email/updatecredoremailprovider',data,{responseType : 'json'})
  }

  GetCredorEmailProvider(){
    return this.http.get(this.APIURL + '/Email/getcredoremailprovider',{responseType : 'json'});
  }
