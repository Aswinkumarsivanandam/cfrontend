...
import { EsignDocumentComponent } from './esign-document/esign-document.component';
...
@NgModule({
  ...
  imports: [
    BrowserModule, NgxDatatableModule, CsvModule,
    ...
    SwiperModule,JoyrideModule.forRoot(),
    CKEditorModule,
    AngularEditorModule,
    NgOtpInputModule,
    NgxDocViewerModule,
  ...
  providers: [DatePipe, EmailEditorComponent, { provide: OWL_DATE_TIME_LOCALE, useValue: 'en' }],
