...
export class SettingsService {
  ...
  GetGeneralInfo(){
    return this.http.get(this.APIURL + '/Account/getcredorcontactinfo',{responseType : 'json'});
  }

  UpdateGeneralInfo(data : any){
    return this.http.put(this.APIURL + '/Account/updatecredorcontactinfo',data,{responseType : 'json'});
  }

  AddContactUsQuery(data : any){
    return this.http.post(this.APIURL + '/Account/createcustomerqueries',data,{responseType : 'json'});
  }

  UpdateTwoFactorAuthentication(data : any){
    return this.http.put(this.APIURL + '/Account/updatetwofactorauthentication',data,{responseType : 'json'});
  }
}
