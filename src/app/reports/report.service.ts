...
export class ReportService {
  ...
  GetInvestorProfileUpdates(){
    return this.http.get(this.APIURL + '/Reports/getinvestorprofileupdatedetails',{responseType : 'json'});
  }

  GetActiveOfferingDetails(){
    return this.http.get(this.APIURL + '/Reports/GetActiveOfferingDetails',{responseType : 'json'});
  }
}
